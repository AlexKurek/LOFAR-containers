...
%environment
	LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/opt/lofar/lib:/opt/casacore/lib:/opt/pybdsf/lib:/opt/dysco/lib:/opt/LOFARBeam/lib/:/opt/aoflagger/lib:/opt/intel/mkl/lib/intel64_lin:/opt/armadillo/lib/:/opt/EveryBeam/lib/:/usr/local/cuda-11.6/lib64/:/usr/local/cuda-11.6/targets/x86_64-linux/lib/:/opt/OpenBLAS/lib:/opt/SuperLU/lib/
...
%post
	...
	# export MKL_ONEAPI_VERSION=2021.4.0
	...
	echo "[mkl]" >> site.cfg
	echo "library_dirs = /opt/intel/compilers_and_libraries_2020/linux/mkl/lib/intel64" >> site.cfg
	echo "include_dirs = /opt/intel/compilers_and_libraries_2020/linux/mkl/include" >> site.cfg
	...
	apt-get install -y -qq libarpack2-dev libatlas-base-dev # libopenblas-dev libsuperlu-dev libsuperlu5
	...
	cmake -DCMAKE_INSTALL_PREFIX=${INSTALLDIR}/armadillo/ -Wno-dev -DCMAKE_CXX_FLAGS="-O3 -march=native -DNDEBUG" -DSuperLU_INCLUDE_DIR=${INSTALLDIR}/SuperLU/include/ -DSuperLU_LIBRARY=${INSTALLDIR}/SuperLU/lib/libsuperlu.so -DCMAKE_PREFIX_PATH="${INSTALLDIR}/OpenBLAS/;${INSTALLDIR}/intel/mkl/lib/intel64_lin/" .
	make -j ${J}
	make install > /dev/null
	cd ../..
	...
	cmake -DCMAKE_PREFIX_PATH="/usr/local/cuda-11.6/lib64/" -DCMAKE_INSTALL_PREFIX=/usr/ -Wno-dev -DCMAKE_CXX_FLAGS="-O3 -march=native -DNDEBUG" -DCMAKE_BUILD_TYPE=Release -DBUILD_WITH_MKL=ON -DBUILD_LIB_CUDA=ON src/
	make -j ${J}
	make install
	cd ../..
	...
	cd ../build/
	cmake -DCMAKE_PREFIX_PATH="${INSTALLDIR}/lofar/;${INSTALLDIR}/armadillo/;${INSTALLDIR}/aoflagger/;${INSTALLDIR}/LOFARBeam/;${INSTALLDIR}/intel/mkl/lib/intel64_lin/" -DCMAKE_INSTALL_PREFIX=${INSTALLDIR}/lofar/ -Wno-dev -DCASACORE_ROOT_DIR=${INSTALLDIR}/casacore/ -DCMAKE_CXX_FLAGS="-O3 -march=native -DNDEBUG" ${INSTALLDIR}/lofar/src/
	make -j ${J}
	make install
	cd ../..
	...
	cd ../build/
	cmake -DCMAKE_PREFIX_PATH="${INSTALLDIR}/EveryBeam/;/usr/local/idg/;${INSTALLDIR}/intel/mkl/lib/intel64_lin/" -DCMAKE_INSTALL_PREFIX=${INSTALLDIR}/WSClean/ -DCASACORE_ROOT_DIR=${INSTALLDIR}/casacore/ -DCMAKE_CXX_FLAGS="-O3 -march=native -DNDEBUG" -DCMAKE_BUILD_TYPE=Release -DMPI_CXX_SKIP_MPICXX=ON -Wno-dev ${INSTALLDIR}/WSClean/src/
	make -j${J}
	make install
	cd ../..
